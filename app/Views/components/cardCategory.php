...
<div class="card card-category">
    <div class="card-body card-category-body">
        ...
        <label class="text-category-namePlace">
            <i class="fas fa-water"></i>&nbsp; น้ำตก
        </label>
        <span class="text-category-numPost">1 โพสต์</span>
        ...
        <label class="text-category-namePlace">
            <i class="fas fa-church"></i>&nbsp; วัด
        </label>
        <span class="text-category-numPost">4 โพสต์</span>

        <br />

        <label class="text-category-namePlace">
            <i class="fas fa-paw"></i>&nbsp; สวนสัตว์
        </label>
        <span class="text-category-numPost">2 โพสต์</span>
