...
INSERT INTO `officer` (`offId`, `FName`, `LName`, `userName`, `password`, `gender`, `offImage`, `phoneNumber`) VALUES
(1, 'Kanokphon', 'Phuangwatpho', 'knp001', '$2y$10$wXl6IDcXX0AkpsqL.NjTnOkrzFT47yoRnBur.Y8eVkiVYdXi2Ba1q', 'ชาย', 'https://media.discordapp.net/attachments/778499819072913482/936489935022747648/158282142_728598437840104_1157295371700176386_n.jpg', '0987392476');
...
ALTER TABLE `participate`
  ...
  ADD KEY `userId` (`userId_user`),
  ADD KEY `postId` (`postId_post`);
...
--
ALTER TABLE `officer`
  MODIFY `offId` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
